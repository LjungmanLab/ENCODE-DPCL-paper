...
def main(start_file, end_file, gene_file, final_file, eval_file):
    ...
    if start_file is None:
        start_file = "~/Desktop/shared_biosamples/read-through/fused_dec/bin_250_old/HCT1160h4001a.RTsegments.TESintersect.segmentRPKM.startsRPKM.bed"
    if end_file is None:
        end_file = "~/Desktop/shared_biosamples/read-through/fused_dec/bin_250_old/HCT1160h4001a.RTsegments.TESintersect.segmentRPKM.endsRPKM.bed"
    if gene_file is None:
        gene_file = "~/Desktop/shared_biosamples/read-through/fused_dec/bin_250_old/HCT1160h4001a.RTsegments.TESintersect.segmentRPKM.genesRPKM.bed"
    if final_file is None:
        final_file = "~/Desktop/shared_biosamples/read-through/fused_dec/bin_250_old/HCT1160h4001a.RTsegments.TESintersect.segmentRPKM.noeval.bed"
    if eval_file is None:
        eval_file = "~/Desktop/shared_biosamples/read-through/fused_dec/bin_250_old/HCT1160h4001a.RTsegments.TESintersect.segmentRPKM.eval.bed"
